...
import com.Ticket.POM.TrainTicket;
...
public class TrainTicketTC {
	 ...
	 private boolean testdone = false;
	    ...
	    @Test(description = "Test_001 : Train Ticket E2E ", priority='1')
	    public void signUpClick()
	            throws Exception {
	        ExtentTest extentTest = extentReports.createTest("Ticket Booked", "Ticket E2E test");
	        try {
	        	ticket.train_tickets_E2E(driver);
	            log.info("Train Ticket booked Succefully ...!!");
	            

	            // Reset flag to true if all test passed
	            testdone = true;
	            extentTest.log(Status.PASS, "Train Ticket booked Succefully...!!");
	            ...
	            log.error("Failed to perform any one operation - Train ticket booking :"
	                    + exception.getMessage());
	            extentTest.log(Status.FAIL, "Failed to perform any one operation - Train ticket booking :");
	            testdone = false;
	        }
